...
void ofApp::draw(){
    ...
    // 100回くりかえし
    for (int i = 0; i < vartex_num; i++) {
        
        //上下左右同じ確率でランダムに移動
        pos.x += ofRandom(-morph_focus*0.1,morph_focus*0.1);
        pos.y += ofRandom(-morph_focus*0.1,morph_focus*0.1);
        
        
        //円を描く
        ofFill();
        //ofDrawCircle(pos.x, pos.y, ofRandom(0.1, 3));
        
        ofNoFill();
        ofSetLineWidth(0.2);
        //ofDrawRectangle(pos.x, pos.y, ofRandom(0.1, 30),ofRandom(0.1, 30));
    }
